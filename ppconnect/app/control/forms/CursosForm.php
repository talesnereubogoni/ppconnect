...
class CursosForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $btn_cancelar = $this->form->addAction(_t('Cancel'), new TAction(['CursosList','onReload']), 'fa:window-close');
    ...
    {        
        try
        {
            ...
            **/
            ...
            $back =  new TAction(array('CursosList','onReload'));           
        ...
        catch (Exception $e) // in case of exception
        {
            ...
            if(strpos($erro, '[23000]'))
                new TMessage('error', 'Curso já cadastrado!'); // shows the exception error message
            else
