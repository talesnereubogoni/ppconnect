<?php
/**
 * PolosForm Form - Cadastro dos polos
...
class PolosForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->addFields( [ new TLabel('Telefone') ], [ $telefone ] , [ new TLabel('Whatsapp') ], [ $whatsapp ] );
        $this->form->addFields( [ new TLabel('Email') ], [ $email ], [ new TLabel('Coordenador') ], [ $coordenador ] );
        ...
        $btn_cancelar = $this->form->addAction(_t('Cancel'), new TAction(['PolosList','onReload']), 'fa:window-close');
