...
class CalendarioForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_Calendario');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Calendario;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('ppconnectpolo'); // open a transaction
                $object = new Calendario($key); // instantiates the Active Record
